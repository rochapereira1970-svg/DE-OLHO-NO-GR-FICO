...
def analyze_and_filter_markets(fixtures):
    ...
    for item in fixtures:
        ...
        # Games from major leagues will be marked as VIP
        is_vip_game = False
        if league_name in ["Premier League", "La Liga", "Serie A", "Bundesliga", "Champions League", "Serie A - Brazil"]:
            is_vip_game = True
...
def main():
    ...
    print(f"Success! Generated {len(processed_games)} matches in 'jogos.json'.")
