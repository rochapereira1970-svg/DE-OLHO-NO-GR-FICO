...
.banner-vip-principal { background: linear-gradient(135deg, #1e1b4b 0%, #311042 100%); border: 1px solid #581c87; padding: 20px; border-radius: 14px; text-align: center; margin-bottom: 25px; }
...
.btn-principal-vip { background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: #000000 !important; font-weight: 900; padding: 12px 30px; border-radius: 8px; text-decoration: none; display: inline-block; text-transform: uppercase; font-size: 14px; }
...
.card-analise { background-color: #1e293b; border-radius: 14px; padding: 20px; margin-bottom: 20px; border-left: 5px solid #38bdf8; }
...
.card-vip-bloqueado { background-color: #131926; border-radius: 14px; padding: 20px; margin-bottom: 20px; border-left: 5px solid #eab308; border: 1px dashed #eab308; opacity: 0.9; }
...
st.markdown("""
    <div class="aviso-horario-box">
        <span class="aviso-texto">📢 Novas projeções gráficas são consolidadas diariamente às 22:00h!</span>
    </div>
""", unsafe_allow_html=True)
    ...
    with aba_vip:
        st.markdown("""
            <div style="background-color: #1e293b; color: #ffedd5; padding: 15px; border-radius: 8px; border-left: 4px solid #f97316; margin-bottom: 20px; font-size: 14px; text-align: center;">
                ⭐ <strong>7 CURVAS DE ALTA VOLATILIDADE EXCLUSIVAS:</strong> Padrões de comportamento com assimetria severa acima de 80% de acerto.
            </div>
        """, unsafe_allow_html=True)
